    ...
    <div class="product-item-holder size-big single-product-gallery small-gallery">
        ...
        <div id="owl-single-product">
            <div class="single-product-gallery-item" id="slide1">
                <a data-lightbox="image-1" data-title="Gallery" href="{{ asset('assets/images/products/' . $chitiet->Anh) }}">
                    <img class="img-responsive" alt="" src="{{ asset('assets\images\blank.gif') }}" data-echo="{{ asset('assets/images/products/' . $chitiet->Anh) }}" width="320" height="320">
                </a>
                ...
                <div class="item">
					...
					<div class='col-sm-6 col-md-7 product-info-block'>
						<div class="product-info">
							<h1 class="name">{{$chitiet->TenSanPham}}</h1>
							...
							<div class="price-container info-container m-t-20">
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="price-box">
											<span class="price">{{$chitiet->GiaKhuyenMai}}</span>
											<span class="price-strike">{{$chitiet->GiaGoc}}</span>
										</div>
									</div>
							...
							<div class="quantity-container info-container">
								<div class="row">
									...
									<div class="col-sm-7">
										<a href="{{url('info')}}" class="btn btn-primary"><i class="fa fa-shopping-cart inner-right-vs"></i> Thêm Vào Giỏ Hàng</a>
									</div>
					...
					<div class="row">
						<div class="col-sm-3">
							<ul id="product-tabs" class="nav nav-tabs nav-tab-cell">
								<li class="active"><a data-toggle="tab" href="#description">Giới Thiệu</a></li>
													...
													<form role="form" class="cnt-form">
														...
														<div class="row">
															<div class="col-sm-6">
																...
																<div class="form-group">
																	<label for="exampleInputSummary">Lời Bình<span class="astk">*</span></label>
															...
															<div class="col-md-6">
																<div class="form-group">
																	<label for="exampleInputReview">Đánh Giá Chi Tiết<span class="astk">*</span></label>
