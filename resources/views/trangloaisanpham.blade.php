  ...
  <div class="container">
    <div class="breadcrumb-inner">
      <ul class="list-inline list-unstyled">
        ...
        <li class='active'>{{ $sanpham->first()->TenLoaiSanPham }}</li>
      </ul>
    </div>
    <!-- /.breadcrumb-inner --> 
  </div>
      ...
      <div class='col-md-3 sidebar'> 
        ...
        <div class="side-menu animate-dropdown outer-bottom-xs">
          ...
          <nav class="yamm megamenu-horizontal">
            <ul class="nav">
              <li class="dropdown menu-item"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="" aria-hidden="true"></i>Sữa</a>
          ...
          <div class="row">
            ...
            <div class="col col-sm-12 col-md-6">
              <div class="col col-sm-3 col-md-6 no-padding">
                <div class="lbl-cnt"> <span class="lbl">Tìm Kiếm</span>
                  <div class="fld inline">
                    <div class="dropdown dropdown-small dropdown-med dropdown-white inline">
                      ...
                      <ul role="menu" class="dropdown-menu">
                        <li role="presentation"><a href="#">Sắp Xếp</a></li>
